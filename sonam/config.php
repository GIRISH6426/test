...
return $message;
    ...
    function user_update($username,$address,$mobileno,$companyname,$emailid){
$conn = connection();
$id=$_GET['id'];



$query="update registration set id='$id', username='$username', address='$address', mobile='$mobile, email='$email' WHERE id = '$id'";
